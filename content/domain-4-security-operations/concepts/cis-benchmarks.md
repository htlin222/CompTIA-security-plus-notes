...
description: "Industry-standard security configuration guidelines from the Center for Internet Security"
draft: false
date: 2026-03-20
tags:
  - domain/4
...
- Parent: [[hardening]] — CIS Benchmarks are the primary reference for system hardening
- See also: [[stig-security-technical-implementation-guide]]
